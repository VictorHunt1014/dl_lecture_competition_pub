...
class ThingsMEGDataset(Dataset):
    def __init__(self, split: str, data_dir: str = "data", resample_rate: int = 128, augment: bool = True) -> None:
        super().__init__()
        ...
        self.X = self.normalize_data_per_subject(self.X, self.subject_idxs)
